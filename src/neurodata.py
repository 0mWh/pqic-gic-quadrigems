...
scipy._lib._util._lazywhere = lambda cond, arrays, f, fillvalue=None, f2=None: scipy._lib.array_api_extra.apply_where(
    cond, arrays, f, f2=f2, fill_value=fillvalue
)
...
def rent_exp(A, coords, M=20):
    ...
    model = sm.RLM(
        log_E_prime, log_N_prime, M=statsmodels.robust.norms.TukeyBiweight()
